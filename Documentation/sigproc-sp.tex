...
\begin{figure}[htbp] 
  \centering
     \includegraphics[width=0.5\linewidth]{pictures/wiring.jpg}
  \caption{Wiring everything on a circuit board}
  \label{fig:fritzing}
\end{figure}

\begin{figure}[htbp] 
  \centering
     \includegraphics[width=0.5\linewidth]{pictures/built_in_electronic.jpg}
  \caption{Built everything in the bar}
  \label{fig:fritzing}
\end{figure}
